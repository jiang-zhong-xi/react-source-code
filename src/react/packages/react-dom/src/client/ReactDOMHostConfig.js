...
// 只有button input select textarea的autofocus有效
...
export function createInstance(
  ...
  // 把domElement对应的fiber（internalInstanceHandle）缓存到domElement的__reactInternalInstance$属性中
  precacheFiberNode(internalInstanceHandle, domElement);
  // 把props添加到domElement的__reactInternalInstance$属性中
...
export function finalizeInitialChildren(
  ...
  /* 
    setInitialProperties完成DOM元素属性的初始化，包括：
    1. 如果fiber中包含了事件属性，则将对应的原始事件类型和传播方式定义、事件处理炳定义在DOM所属的document上
  */
