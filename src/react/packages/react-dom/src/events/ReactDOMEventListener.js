...
function handleTopLevel(bookKeeping) {
  ...
  // 把自身fiber和root对应的fiber的上级fiber存入ancestors
  do {
    if (!ancestor) {
...
/* 
 为document绑定topLevelType类型的冒泡事件
*/
/**
...
export function dispatchEvent(
  ...
  // 从nativeEvent中获取源targetDOM，冒泡到达的DOM存储在currentTarget中
  const nativeEventTarget = getEventTarget(nativeEvent);
  // 获取targetDOM对应的或者最近的fiber
  ...
  // 将事件类型、原生事件、源DOM对应的最近的fiber组合到bookKeeping中
