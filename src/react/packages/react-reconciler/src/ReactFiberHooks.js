...
export function renderWithHooks(
  ...
  /* 因为nextCurrentHook===null，所以我们把update render标识为mount，这是个技巧因为他对某些组件类型是有效的 */
  ...
  if (__DEV__) {
    if (nextCurrentHook !== null) {
      ...
      /* 
        dispatcher处理组件正在更新但是没有使用状态钩子函数的情况。
        我们想要匹配生产环境的代码使用”HooksDispatcherOnMount“的行为。但是需要额外的验证来确保顺序不变而dispatcher就是做这个的。
      */
  ...
  let children = Component(props, refOrContext); // 获取返回的虚拟DOM
